...
- 🔴🟡🟢 **三级风险评级** + 置信度
- 📐🧠 **双路命中信号**（规则强度 + 语义相似度）
- 📚 **匹配的诈骗案例**（含作案手法 / 反诈预警要点 / 三步行动建议 / 公开来源）
- 📤 **可转发卡片**（一键发到班群提醒同学）
...
<sub>检测结果卡片：风险评级 + 命中高亮 + 为什么可疑 + 三步建议 + 反诈预警要点 + 公开来源</sub>
</div>
...
# → 4/4 通过：KB schema · 规则路 12/12 · 反诈要点覆盖 · 紧急电话齐全
```
...
| v0.2 · 对话卡片输出 | ✅ | 风险横条 / 关键词高亮 / 反诈预警要点引用 |
...
<div align="center">
<sub>Made with ☕ by 鲍海文 · 南京大学经济学（拔尖计划）· OpenClaw 应用创新大赛参赛 Demo</sub>
</div>
