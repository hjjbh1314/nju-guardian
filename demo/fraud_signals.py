...
反诈预警要点。只要行为模式像诈骗，**即使案例库里没有对应类型，也能给出风险预警**。
...
SIGNALS: list[dict] = [
    ...
    {"id": "toogood", "name": "承诺超额 / 稳赚回报", "severity": 2,
     "rule": "反诈预警要点·第一 / 二条：宣称稳赚不赔、内幕消息、高额返利、刷单返佣的，都是诈骗",
