...
| **📤 可转发卡片** | 检测后一键生成可发到班群/朋友圈的简洁文字（含案例 + 行动建议 + 反诈预警要点 + 紧急联系）|
...
| 更新点 | 说明 |
|---|---|
| **对话卡片输出** | 报告改成结构化卡片：彩色风险横条 + 命中关键词高亮 + 反诈预警要点引用块 + 三步建议 |
| **反诈预警要点匹配** | 自动从命中案例里抽出"国家反诈预警要点"对应条目并独立展示 |
...
2. **3–10 秒**：「文本检测」Tab，点示例"辅导员代收班费" → 红色高风险 + 反诈预警要点·第六条匹配
